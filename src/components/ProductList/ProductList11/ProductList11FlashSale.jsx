...
import ProductItem11FlashSale from "../../ProductItem/ProductItem11/ProductItem11FlashSale";
...
export default function ProductList11FlashSale(props) {
            ...
            >
              <div className="product-list">
                <div className="ajax-response">
                  <Slider {...settings2}>
                    {firstLine.map((v, i) => (
                      <ProductItem11FlashSale product={v} />
                    ))}
                  </Slider>
                </div>
              </div>
