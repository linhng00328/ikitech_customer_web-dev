    ...
    if (categories[index]) {
      items.push(
        <li>
          ...
          <Link to={`/san-pham?danh-muc=${categories[index].slug}-${categories[index].id}`} className="menu-title">
            {value[0]}
          </Link>
        </li>,
      );
          ...
          <div className="container">
            <div className="row">
              <div className="col-12 contact">
                ...
                <span>
                  <a href={'mailto:' + appTheme.contact_email}>{appTheme.contact_email}</a>
                </span>
              </div>
              <div className="col-9 search-bar">
                <form onSave={handleSearch} className="search-wrapper Module Module-217">
                  ...
                  >
                    ...
                    <button onClick={handleSearch} id="ctl00_mdl217_ctl00_Search_btnSearch" className="searchbutton">
            ...
            <div className="top-header-wrap flex justify-between items-center">
              ...
              <div className="top-header-right">
                <div className="header-util-list flex items-center">
                  ...
                  >
                    <Notification fontSize={24} useIcon={true} hideTitle={true}></Notification>{' '}
                  </div>
                  <div
                    style={{
                      width: 'auto',
                  ...
                  >
                    <ProfileUser hideIcon={true} accountInfoStyle={{ position: 'unset' }} />
                  </div>

                  <div className="col col-lg-1 col-sm-2" style={{ marginLeft: '0.5em' }}>
                    <div className="cart-wrapper Module Module-218">
                      <div className="ModuleContent">
                        <div className="cart">
                          <div className="cart-toggle position-relative inline-block">
                      ...
                      <ul className="flex items-center col-12 text-center">
                        <li>
                          <a href="/tin-tuc" className="menu-link text-center">
                            <div className="menu-img">
                              <img width={50} src="/img/logo-daika.png" alt="Về chúng tôi" />
                            </div>
                            <div className="menu-img-hover">
                              <img width={50} src="/img/logo-daika-hover.png" alt="Về chúng tôi" />
                            </div>
                          </a>
                        ...
                        <li>
                          <Link to="/ma-giam-gia" className="menu-link text-center">
                            <div className="menu-img">
                              <img src="/img/menu_img9.webp" alt="Voucher" />
                            </div>
                            <div className="menu-img-hover">
                              <img src="/img/menu_img9_hover.webp" alt="Voucher" />
                            </div>
                          </Link>
                          <Link
                            to={{
                        ...
                        <li>
                          <Link to="/combo-giam-gia" className="menu-link text-center">
                            <div className="menu-img">
                              <img src="/img/menu_img9.webp" alt="Combo Giảm giá" />
                            </div>
                            <div className="menu-img-hover">
                              <img src="/img/menu_img9_hover.webp" alt="Combo Giảm giá" />
                            </div>
                          </Link>
                          <Link
                            to={{
                        ...
                        {allowCalculate() == true && (
                          <li>
                            <Link to="/bao-gia" className="menu-link text-center">
                              <div className="menu-img">
                                <img src="/img/menu_img9.webp" alt="Báo giá" />
                              </div>
                              <div className="menu-img-hover">
                                <img src="/img/menu_img9_hover.webp" alt="Báo giá" />
                              </div>
                            </Link>
                            <Link
                              to={{
