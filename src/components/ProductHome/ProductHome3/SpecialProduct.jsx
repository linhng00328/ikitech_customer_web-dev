...
const SpecialProductStyles = styled.section`
  .slick-slider {
    .slick-prev {
      left: 5px !important;
    }
...
export default function HomeBanner(props) {
  ...
  return (
    <SpecialProductStyles className="awe-section-3 product3">
              ...
              <h2>
                ...
                >
                  <svg
                    ...
                    style={{ enableBackground: "new 0 0 511.548 511.548" }}
                    xmlSpace="preserve"
                    width={512}
                    height={512}
                  >
