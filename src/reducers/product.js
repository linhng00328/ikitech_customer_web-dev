...
export function product(state = initialState, action) {
  switch (action.type) {
    ...
    case c.GET_LIST_ATTRIBUTES_PRODUCT_SUCCESS:
      return {
        ...state,
        listAttributes: {
          list: action.data,
    ...
    case c.GET_LIST_ATTRIBUTES_PRODUCT_FAILURE:
      return {
        ...state,
        listAttributes: {
          list: [],
    ...
    case c.GET_SUGGEST_PRODUCTS_SUCCESS:
      return {
        ...state,
        listSuggest: {
          ...action.data,
    ...
    case c.GET_SUGGEST_PRODUCTS_FAILURE:
