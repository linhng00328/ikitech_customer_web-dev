...
const AgencyReportChartStyles = styled.div`
  .report__content {
    display: flex;
...
const AgencyReportChart = () => {
  ...
  function getReport(query) {
    dispatch(a.getAgencyReport(query));
  }
  ...
  return !reportData2 ? (
    ...
    <AgencyReportChartStyles className="report">
    ...
    </AgencyReportChartStyles>
  );
};

export default AgencyReportChart;
