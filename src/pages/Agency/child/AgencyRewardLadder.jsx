...
const AgencyRewardLadderStyles = styled.div`
  table {
    width: 100%;
...
const AgencyRewardLadder = () => {
  ...
  return (
    <AgencyRewardLadderStyles className="receipt-tab">
          ...
          <tbody>
            {bonus.data.map((v, i) => (
              <tr key={i}>
                ...
                <td className="value">{formatPrice(v.share_agency)}</td>
    ...
    </AgencyRewardLadderStyles>
  );
};

export default AgencyRewardLadder;
